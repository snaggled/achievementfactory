...
This was a coding challenge I took a number of years back for a development job at a gaming company. I was pleased with the result. What follows are the requirements I was supplied with.
...
• Your system should be extensible in the following ways:
	o The system must easily handle the tracking of additional statistics at any level listed above (historical by player or game-specific by player)
